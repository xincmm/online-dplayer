...
class Danmaku {
    ...
    load() {
        ...
        if (this.options.api.maximum) {
            apiurl = `${this.options.api.address}danmaku/?id=${this.options.api.id}&max=${this.options.api.maximum}`;
        } else {
            apiurl = `${this.options.api.address}danmaku/?id=${this.options.api.id}`;
        }
